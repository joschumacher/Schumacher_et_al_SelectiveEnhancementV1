# right_syringe_pump.py: Syringe Pump interface
...
class RightSyringePump(SerialPort):
    ...
    def __init__(self, serialPortName):
        ...
        super(RightSyringePump, self).__init__(serialPortName)
        self.total_mL = 0
    
    def bolus_right(self, mL):
        """
