...
def load_parameters(task):
    ...
    task.sPlusOrientations = [135]   #[0, 45, 90, 135]
    task.sMinusOrientations =   [145, 157.5, 180]  #removed 145, 6/19/18 #%[90, 112.5, 125]%original  # [40]
    ...
    task.hintChance = .1 # chance of sending a low reward at the start of the reward period
